  ...
  return (
    ...
    >
      <SketchFrame className="h-full w-full">
        <article className="flex h-full min-h-[470px] flex-col overflow-hidden rounded-[12px] bg-white">
          ...
          <div className="flex flex-1 flex-col items-center justify-start px-6 py-6 text-center">
